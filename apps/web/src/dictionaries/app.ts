...
const ar: AppDictionary = {
  ...
  nav: {
    ...
    logoutAria: 'خروج',
    themeAria: 'تبديل الوضع الداكن والفاتح',
  },
  login: {
    title: 'مرحباً بك من جديد',
    subtitle: 'سجّل الدخول إلى حسابك وأكمل رحلتك نحو الزواج',
  ...
  register: {
    ...
    errorEmailTaken: 'هذا البريد الإلكتروني مسجّل من قبل',
    passwordLabel: 'كلمة المرور',
    passwordRequired: 'يجب إدخال كلمة المرور',
    passwordMinLength: 'يجب أن تتكون من 8 أحرف على الأقل',
    firstNameLabel: 'الاسم الأول',
    firstNameRequired: 'يجب إدخال الاسم الأول',
    genderLabel: 'الجنس',
    genderMale: 'ذكر',
    genderFemale: 'أنثى',
    birthDateLabel: 'تاريخ الميلاد',
    birthDateRequired: 'يجب تحديد تاريخ الميلاد',
    residenceCountryLabel: 'بلد الإقامة الحالية',
    residenceCountryPlaceholder: 'المغرب، فرنسا، الإمارات...',
    residenceCountryRequired: 'يجب تحديد بلد الإقامة',
    currentCityLabel: 'المدينة',
    currentCityRequired: 'يجب تحديد المدينة',
    originCountryLabel: 'بلد الأصل',
    originCountryRequired: 'يجب تحديد بلد الأصل',
    relocationLabel: 'الاستعداد للانتقال أو الزواج من الجالية',
    relocationOpen: 'مستعد للانتقال',
    relocationExpat: 'أبحث ضمن الجالية',
    relocationLocal: 'في بلدي فقط',
    ...
    next: 'التالي',
    submit: 'إنشاء الحساب',
    errorPhoneTaken: 'رقم الهاتف هذا مسجّل من قبل',
  ...
  verificationBanner: {
    ...
    unverifiedSubtitle: 'احصل على شارة "عضو جاد وموثّق" وزد فرصك في الظهور ضمن نتائج البحث',
    pendingTitle: 'التوثيق قيد المراجعة',
    pendingSubtitle: 'سنراجع وثائقك ونعلمك بالنتيجة قريباً',
    rejectedTitle: 'تم رفض التوثيق',
    rejectedSubtitle: 'حاول إرسال وثيقة أوضح، أو تواصل مع الدعم',
    verifyNow: 'وثّق الآن',
  },
  matches: {
    title: 'الاهتمامات والمطابقات',
    loading: 'جارٍ التحميل...',
    empty: 'لا توجد أي اهتمامات حالياً',
    statusPending: 'قيد الانتظار',
    statusAccepted: 'متوافقان',
    statusRejected: 'مرفوض',
    statusEngaged: 'مخطوبان 💍',
    directionSent: 'أرسلت اهتماماً',
    directionReceived: 'أرسل إليك اهتماماً',
    accept: 'قبول',
    reject: 'رفض',
    chat: 'المحادثة',
  ...
  chat: {
    ...
    limitReached: 'وصلت إلى حد الرسائل المجانية',
    unlockChat: 'افتح المحادثة',
    placeholder: 'اكتب رسالتك...',
    send: 'إرسال',
    errorSendFailed: 'تعذّر إرسال الرسالة',
    errorUnlockFailed: 'لا تملك نقاطاً كافية، اشحن رصيدك أو ترقَّ إلى VIP',
    vipComingSoon: 'باقة VIP قريباً 🚀',
  },
  paywallModal: {
    title: 'وصلت إلى مرحلة مهمة!',
    body: (coinCost) => `لمتابعة المحادثة بسلاسة، افتحها بـ ${coinCost} نقطة أو ترقَّ إلى VIP للمحادثة دون حدود`,
    upgradeVip: 'الترقية إلى VIP',
    unlockWithCoins: (coinCost) => `فتح بـ ${coinCost} نقطة`,
    close: 'إغلاق',
  },
  settings: {
    title: 'الإعدادات',
    changePasswordTitle: 'تغيير كلمة المرور',
    changePasswordSubtitle: 'أدخل كلمة المرور الحالية، وحدد كلمة مرور جديدة',
  ...
  profile: {
    title: 'ملفي الشخصي',
    subtitle: 'عدّل المعلومات التي يراها الأعضاء الآخرون',
    firstNameLabel: 'الاسم الأول',
    currentCityLabel: 'المدينة',
    residenceCountryLabel: 'بلد الإقامة الحالية',
    originCountryLabel: 'بلد الأصل',
  ...
  store: {
    ...
    coinPackagesTitle: 'باقات النقاط',
    topUp: 'شحن',
    topUpFor: (coins) => `شحن ${coins} نقطة`,
    vipPerks: 'محادثات بلا حدود، رؤية جميع الزوار، وأولوية في الظهور',
    upgradeNow: 'ترقَّ الآن',
    upgradeTitle: 'اشتراك VIP',
    historyTitle: 'سجل العمليات',
    historyEmpty: 'لا توجد أي عمليات حالياً',
    statusPending: 'قيد الانتظار',
    statusSuccess: 'مؤكدة ✓',
    statusFailed: 'مرفوضة',
    typeCoinPurchase: 'شحن نقاط',
  ...
  paymentModal: {
    ...
    doneTitle: 'تم إرسال طلبك للمراجعة',
    doneSubtitle: 'سنؤكد العملية ونفعّل الخدمة قريباً',
    doneButton: 'حسناً',
    errorGeneric: 'حدث خطأ ما، حاول مرة أخرى',
  },
  verification: {
    title: 'وثّق حسابك مجاناً',
    subtitle: 'أرسل بطاقة التعريف أو جواز السفر للحصول على شارة "عضو جاد وموثّق" وزد فرصك في الظهور',
    idLabel: 'صورة بطاقة التعريف / جواز السفر',
    residencyLabel: 'وثيقة الإقامة بالخارج (اختياري)',
    submit: 'أرسل للمراجعة',
    skip: 'تخطَّ الآن، وثّق لاحقاً',
    alreadyVerified: 'حسابك موثّق بالفعل ✓',
    alreadyPending: 'طلب التوثيق الخاص بك قيد المراجعة، سنعلمك بالنتيجة قريباً',
  },
  visitors: {
    title: 'زوار ملفك الشخصي',
    subtitle: 'هؤلاء هم الأشخاص الذين زاروا ملفك الشخصي مؤخراً',
    lockedBanner: (count) => `${count} زوار آخرين زاروا ملفك الشخصي! ترقَّ إلى VIP لمعرفة من هم`,
    loading: 'جارٍ التحميل...',
    empty: 'لم يزر أحد ملفك الشخصي بعد',
    lockLabel: 'ترقَّ إلى VIP',
    lockedName: '••••••',
    unknownVisitorAlt: 'زائر مقفل',
  },
  promoInput: {
    title: 'هل لديك كود ترويجي؟',
    subtitle: 'أدخل الكود وفعّل مكافأتك فوراً',
  ...
  referralCard: {
    title: 'شارك وادعُ أصدقاءك',
    subtitle: 'كل صديق يوثّق حسابه عبر رابطك، تربحان معاً 10 كوينات.',
    copyLink: 'نسخ الرابط',
    copied: 'تم النسخ',
    whatsapp: 'واتساب',
    facebook: 'فيسبوك',
    shareText: (link) => `سجّل معي في قسمة و نصيب، منصة جادة للزواج الحلال 💍 استخدم رابطي: ${link}`,
    totalReferredLabel: 'سجّلوا عبر الرابط',
    verifiedReferredLabel: 'وثّقوا حساباتهم وربحتَ الكوينات',
  },
  imageUploader: {
    uploading: 'جارٍ الإرسال...',
    changePhoto: 'تغيير الصورة',
    choosePhoto: 'اختر صورة',
    errorUploadFailed: 'تعذّر رفع الصورة، حاول مرة أخرى',
  },
  languageSelector: {
    label: 'اللغة',
  },
